	...
	<div class="row clearfix">
		<div class="col-md-12 column">
		  <div class="col-md-12 column">
			...
			<br><br><br>
<!--  Carousel  -->
			<div style="height:480" id="this-carousel-id" class="carousel slide"><!-- class of slide for animation -->
				<div class="carousel-inner">
					<div class="item active"><!-- class of active since it's the first item -->
 			     		<img src="img/2.jpg" height="480" width="1200" alt="" />
 			     		<div class="carousel-caption">
 			     			<p><strong class="">Your Radio </strong></p>
 			     		</div>
 					</div>
 					<div class="item">
 			    		<img src="img/1.jpg" height="480" width="1200" alt="" />
 			    		<div class="carousel-caption">
 			    			<p><strong class="">Live Radio </strong></p>
 			     		</div>
 					</div>
  					<div class="item">
  						<img src="img/3.jpg" height="480" width="1200" alt="" />
  			    		<div class="carousel-caption">
 			    			<p><strong class="">Best Radio </strong></p>
 			    		</div>
 					</div>
 					<div class="item">
 			    		<img src="img/4.jpg" height="480" width="1200" alt="" />
  			    		<div class="carousel-caption">
  			    			<p><strong class="">Your Dj Live </strong></p>
  			   			</div>
  					</div>
  				</div>  <!-- /.carousel-inner -->
    		...
    		<div class="panel panel-default target" align="center">
				...
				<?php
					...
					while ($row = mysql_fetch_assoc($result)) {
        				...
        				$mp3_name[]=$row['name'];
        				$mp3_image[]=$row['image'];
        				$mp3_nb_like[]=$row['nb_like'];
        				$mp3_nb_share[]=$row['nb_share'];
        				$mp3_nb_comment[]=$row['nb_comment'];
        				$mp3_date=$row['mp3_date'];
        				$mp3_time=$row['mp3_time'];
