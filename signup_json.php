						...
						if (mysql_num_rows($check)>=1)  $reponse="Username already taken";
							...
							if (mysql_num_rows($checkemail)>=1) $reponse="email already taken";
								...
								if (!mail($to,$subject,$body,$headers))
									...
									$register = mysql_query("INSERT INTO member(username,password,img,email,code,initcode,etat,signup_date,signup_time) VALUES ('$username','$password','./img/user/0.jpg','$email','$code','$initcode','OK','$date','$time')");
